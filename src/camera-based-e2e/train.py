...
if __name__ == "__main__":
    ...
    parser.add_argument('--teacher_forcing_start', type=float, default=1.0, help='Teacher forcing start ratio (epoch 0)')
    parser.add_argument('--teacher_forcing_end', type=float, default=0.3, help='Teacher forcing end ratio (last epoch)')
    args = parser.parse_args()

    # Data
    train_dataset = WaymoE2E(indexFile='index_train.pkl', data_dir=args.data_dir, n_items=250000)
    test_dataset = WaymoE2E(indexFile='index_val.pkl', data_dir=args.data_dir, n_items=50000)
    ...
    lit_model = LitModel(model, lr=args.lr)

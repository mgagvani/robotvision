...
if __name__ == "__main__":
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[
            ModelCheckpoint(
                monitor="val_ade_pred",
                mode="min",
                save_top_k=1,
                dirpath=ckpt_dir,
                filename="camera-e2e-{epoch:02d}-{val_ade_pred:.2f}",
            ),
        ],

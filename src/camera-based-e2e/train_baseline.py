...
from models.base_model_baseline import LitModel, collate_with_images
from models.monocular_baseline import DeepMonocularModel
from models.feature_extractors import SAMFeatures

from loader_baseline import WaymoE2E  # Adjust if using nuscenes
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--occ_root", type=str, default=None, help="Path to occupancy root directory")
    ...
    # Dataset
    train_dataset = WaymoE2E(indexFile="index_train.pkl", data_dir=args.data_dir, n_items=50000,)
    val_dataset = WaymoE2E(indexFile="index_val.pkl", data_dir=args.data_dir, n_items=5000,)
    ...
    ckpt_dir = base_path / "checkpoints_baseline"

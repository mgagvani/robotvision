...
from models.base_model_occ import LitModel, collate_with_images
from models.monocular_occ import DeepMonocularModel
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--occ_root", type=str, required=True, help="Path to occupancy root directory"
    )
    ...
    if args.dataset == "waymo":
        from loader_occ import WaymoE2E
    ...
    ckpt_dir = base_path / "checkpoints_occ"

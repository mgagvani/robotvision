...
if __name__ == "__main__":
    ...
    # Data 
    train_dataset = WaymoE2E(indexFile='index_train.pkl', data_dir=args.data_dir, images=True, n_items=125_000, use_precomputed=True, precomputed_dir=pre_dir+'train/')
    test_dataset = WaymoE2E(indexFile='index_val.pkl', data_dir=args.data_dir, images=True, n_items=5_000, use_precomputed=True, precomputed_dir=pre_dir+'val/')
